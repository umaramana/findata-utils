...
- **Run**: `cd review && .venv/bin/python -m unittest test_drake test_redact_wrapper test_img_to_pdf test_eligibility test_page_filter` (67 tests). Redactor: `cd redactor && ../review/.venv/bin/python test_redact.py` (95 checks, script) + `../review/.venv/bin/python -m unittest test_redact_and_verify` (6 tests).
